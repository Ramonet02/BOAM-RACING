  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Dorsal fantasma detrás del dibujo */}
        <span
          aria-hidden="true"
          className="pointer-events-none absolute inset-0 flex select-none items-center justify-center font-heading text-[clamp(5rem,16vw,9rem)] leading-none tracking-[0.06em] text-text-primary/[0.05]"
        >
          {unitCode}
        </span>
        ...
        <CarLineArt className="relative z-10 text-text-secondary transition-colors duration-500 group-hover:text-sand motion-reduce:transition-none" />
